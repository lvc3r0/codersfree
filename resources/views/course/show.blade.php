<x-app-layout>
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section>
                <h1 class="font-bold text-3xl mb-2 text-gray-800">Decripcion</h1>
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    @can('enrolled', $course)
                        <a href="{{ route('courses.status', $course) }}" class="btn btn-red btn-block mt-4">Continuar
                            con
                            el curso</a>
                    @else
                        <form action="{{ route('courses.enrolled', $course) }}" method="post">
                            @csrf
                            <button class="btn btn-red btn-block mt-4">Llevar este curso</button>
                        </form>
                    @endcan
                </div>
            </section>
                        ...
                        <div class="ml-3">
                            <h1>
                                <a class="font-bold text-gray-500 mb-3"
                                    href="{{ route('courses.show', $similar) }}">{{ Str::limit($similar->title, 40) }}
                                </a>
                            </h1>
