            ...
            <div class="lg:col-span-3" x-data="{open:true}" x-show="open">
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    ...
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                        <svg x-on:click="open = !open" class="fill-current h-6 w-6 text-red-500" role="button"
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="mb-12">
                        ...
                        <div class="bg-white py-2 px-4" x-show="open">
                            <ul class="grid grid-cols-1 gap-2">
                                @foreach ($section->lessons as $lesson)
                                    <li class="text-gray-700 text-base mb-2">
                ...
                @empty
                    <article class="card">
                        <div class="card-body">
                            Este curso no tiene ninguna seccion asiganda.
                        </div>
                    </article>
                @endforelse
            </section>
            ...
            <section>
                <h1 class="font-bold text-3xl mb-2">Decripcion</h1>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a class="text-blue-400 text-sm font-bold"
                                href="">{{ '@' . Str::slug($course->teacher->name, '') }}
                            </a>
                        </div>
                    </div>
                    <form action="{{ route('admin.courses.approved', $course) }}" class="mt-4" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-blue w-full">Aprovar curso</button>
                    </form>
                    <a class="btn btn-red w-full block text-center mt-4"
                        href="{{ route('admin.courses.observation', $course) }}">Observar curso</a>
                </div>
            </section>
        </div>
    </div>
