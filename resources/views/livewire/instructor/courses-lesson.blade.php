                ...
                @else
                    <header>
                        <h1 x-on:click="open = !open" class="cursor-pointer"><i
                                class="far fa-play-circle text-blue-500 mr-1"></i>Leccion: {{ $item->name }}</h1>
                    </header>
                    <div x-show="open">
                        <hr class="my-2">
                        ...
                        <div>
                            @livewire('instructor.lesson-resource', ['lesson' => $item],
                            key('lesson-resource'.$item->id))
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flex justify-end">
                        <button class="btn btn-red" x-on:click="open = false">Cancelar</button>
